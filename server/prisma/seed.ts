import { PrismaClient, TransactionType, Frequency, RecurringStatus } from '@prisma/client';
...
async function main() {
  ...
  console.log('👤 Creating demo user (demo@fintrack.app)...');
  ...
  console.log('📁 Creating expense and income categories...');
  ...
  console.log('💳 Generating 6 months of historical transactions...');
  const now = new Date();
  ...
  console.log('📊 Setting up monthly category budgets...');
  ...
  console.log(`Total Seeded Transactions: ${transactionsToCreate.length}`);
  console.log('==================================================');
}
